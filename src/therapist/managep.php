<?php
    ...
    $patient_json = json_decode(ssl::get_content('http://172.25.76.76/api/team1/user/uid/' . $patientId));
    ...
    $consents_list_json = json_decode(ssl::get_content('http://172.25.76.76/api/team1/consent/user/' . $result->uid));
