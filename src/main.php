<?php
    ...
    */
    ...
    if ($user_type === "patient") {
        ...
        $treatment_pending_json = json_decode(ssl::get_content('http://172.25.76.76/api/team1/treatment/patient/' . $user_json->uid . '/false'));
        ...
        $therapists_list_json = json_decode(ssl::get_content('http://172.25.76.76/api/team1/treatment/patient/' . $user_json->uid . '/true'));
        ...
        $documents_list_json = json_decode(ssl::get_content('http://172.25.76.76/api/team1/consent/user/' . $result->uid . '/true'));
        ...
        if ($user_json->qualify === 1) {
            ...
            for ($i = 0; $i < $num_documents; $i++) {
                ...
                $record_details = json_decode(ssl::get_content('http://172.25.76.76/api/team1/record/' . $consent->rid));
        ...
        $treatment_reqs_json = json_decode(ssl::get_content('http://172.25.76.76/api/team1/treatment/therapist/' . $user_json->uid . '/false'));
        ...
        <div id="Documents" class="tabcontent">
            ...
            <table class="main-table">
                ...
                <?php for ($i = 0; $i < $num_documents; $i++) {
                    ...
                    $document = json_decode(ssl::get_content('http://172.25.76.76/api/team1/record/get/' . $documentId));
